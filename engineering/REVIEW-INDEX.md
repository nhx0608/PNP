...
| 131 | [docs/team/handoff-template.md](docs/team/handoff-template.md) | 共同 | 分工与协作 |
| 132 | [docs/team/ownership.json](docs/team/ownership.json) | 共同 | 分工与协作 |
| 133 | [docs/team/repository-import.md](docs/team/repository-import.md) | 共同 | 分工与协作 |
| 134 | [docs/team/work-packages.md](docs/team/work-packages.md) | 共同 | 分工与协作 |
| 135 | [INSTRUCTION.md](INSTRUCTION.md) | 共同 | 入口与配置 |
| 136 | [prompts/00-baseline-check.md](prompts/00-baseline-check.md) | 共同 | Prompt |
| 137 | [prompts/01-A-acp.md](prompts/01-A-acp.md) | 共同 | Prompt |
| 138 | [prompts/02-B-pi.md](prompts/02-B-pi.md) | 共同 | Prompt |
| 139 | [prompts/03-C-internal.md](prompts/03-C-internal.md) | 共同 | Prompt |
| 140 | [prompts/04-integration.md](prompts/04-integration.md) | 共同 | Prompt |
| 141 | [prompts/05-internal-acceptance.md](prompts/05-internal-acceptance.md) | 共同 | Prompt |
| 142 | [prompts/06-review.md](prompts/06-review.md) | 共同 | Prompt |
| 143 | [prompts/07-resume.md](prompts/07-resume.md) | 共同 | Prompt |
| 144 | [prompts/08-handoff.md](prompts/08-handoff.md) | 共同 | Prompt |
| 145 | [prompts/README.md](prompts/README.md) | 共同 | Prompt |
| 146 | [README.md](README.md) | 共同 | 入口与配置 |
| 147 | [verification/coverage.md](verification/coverage.md) | 共同 | 验证证据 |
| 148 | [verification/internal/evidence.example.json](verification/internal/evidence.example.json) | C | 验证证据 |
| 149 | [verification/logs/boundaries.txt](verification/logs/boundaries.txt) | 共同 | 验证证据 |
| 150 | [verification/logs/core-typecheck.txt](verification/logs/core-typecheck.txt) | 共同 | 验证证据 |
| 151 | [verification/logs/npm-resolution.txt](verification/logs/npm-resolution.txt) | 共同 | 验证证据 |
| 152 | [verification/logs/release-gate.json](verification/logs/release-gate.json) | 共同 | 验证证据 |
| 153 | [verification/logs/unit.tap](verification/logs/unit.tap) | 共同 | 验证证据 |
| 154 | [verification/results.json](verification/results.json) | 共同 | 验证证据 |
| 155 | [VERIFY.mjs](VERIFY.mjs) | 共同 | 入口与配置 |
<!-- FILE-TABLE:END -->
